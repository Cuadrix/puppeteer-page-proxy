...
module.exports = async function(page, proxy, enableCache = true) {
    page["_proxy"] = proxy;
...
module.exports.lookup = async function(page, lookupService = "https://api.ipify.org?format=json", isJSON = true, timeout = 30000) {
    // Executes clientside code to request data from a lookup service
    ...
    try {
        // Bypass Content Security Policy to be able to make requests to other sites
        await page.setBypassCSP(true);
        const errName = "xhrFailed";
        // Check if function has already been exposed to avoid errors
        // Calls this function if the client side request fails or times out
        ...
        // If failed due to navigation to another page, try again in the new execution context
